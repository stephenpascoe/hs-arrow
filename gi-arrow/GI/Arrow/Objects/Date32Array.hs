...
instance GObject Date32Array where
    gobjectType _ = c_garrow_date32_array_get_type
    

-- | Type class for types which can be safely cast to `Date32Array`, for instance with `toDate32Array`.
class GObject o => IsDate32Array o
#if MIN_VERSION_base(4,9,0)
instance {-# OVERLAPPABLE #-} (GObject a, O.UnknownAncestorError Date32Array a) =>
    IsDate32Array a
#endif
instance IsDate32Array Date32Array
instance Arrow.NumericArray.IsNumericArray Date32Array
instance Arrow.PrimitiveArray.IsPrimitiveArray Date32Array
instance Arrow.Array.IsArray Date32Array
instance GObject.Object.IsObject Date32Array
...
instance (info ~ ResolveDate32ArrayMethod t Date32Array, O.MethodInfo info Date32Array p) => O.IsLabelProxy t (Date32Array -> p) where
    fromLabelProxy _ = O.overloadedMethod (O.MethodProxy :: O.MethodProxy info)

#if MIN_VERSION_base(4,9,0)
instance (info ~ ResolveDate32ArrayMethod t Date32Array, O.MethodInfo info Date32Array p) => O.IsLabel t (Date32Array -> p) where
...
-- Lengths : []
-- returnType : Just (TInterface (Name {namespace = "Arrow", name = "Date32Array"}))
-- throws : False
-- Skip return : False
...
date32ArrayNew ::
  ...
  number of nulls are computed from /@nullBitmap@/. -}
    -> m Date32Array
    {- ^ __Returns:__ A newly created 'GI.Arrow.Objects.Date32Array.Date32Array'. -}
...
date32ArrayGetValue ::
    ...
    a
    {- ^ /@array@/: A 'GI.Arrow.Objects.Date32Array.Date32Array'. -}
    -> Int64
...
instance (signature ~ (Int64 -> m Int32), MonadIO m, IsDate32Array a) => O.MethodInfo Date32ArrayGetValueMethodInfo a signature where
    overloadedMethod _ = date32ArrayGetValue
...
instance (signature ~ (m [Int32]), MonadIO m, IsDate32Array a) => O.MethodInfo Date32ArrayGetValuesMethodInfo a signature where
    overloadedMethod _ = date32ArrayGetValues
